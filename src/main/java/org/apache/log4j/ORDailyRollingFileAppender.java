...
/**
 * 自定义log4j类，用户自定义日志文件名
 *
 */
public class ORDailyRollingFileAppender extends FileAppender {
  ...
  */
  ...
  public ORDailyRollingFileAppender() {
  }
  ...
  /**
    ...
    */
  public ORDailyRollingFileAppender (Layout layout, String filename,
  ...
  public void activateOptions() {
    ...
    if(datePattern != null && fileName != null) {
      ...
      //重写实现自定义文件名格式
      scheduledFilename = fileName.substring(0, fileName.lastIndexOf("."))+sdf.format(new Date(file.lastModified()))+".log";
  ...
  */
  void rollOver() throws IOException {
	...
	if (fileName != null && fileName.length() > 0) {
		datedFilename = fileName.substring(0, fileName.lastIndexOf(".")) + sdf.format(now) + ".log";
	}
